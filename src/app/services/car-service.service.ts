...
export class CarServiceService {
  ...
  private carsSubject$: Subject<ECarsData[]> = new BehaviorSubject<ECarsData[]>(this.cars);
  cars$: Observable<ECarsData[]> = this.carsSubject$.asObservable();
